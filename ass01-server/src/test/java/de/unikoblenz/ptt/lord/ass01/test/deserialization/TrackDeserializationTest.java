...
public class TrackDeserializationTest  extends DeserializationTest {
	...
	public void deserializeTrack() throws Exception {
		...
		final Track userFromJSON = OBJECT_MAPPER.readValue(fixture("fixtures/entities/track.json"), Track.class);
	...
	public void deserializeTracks() throws Exception {
		...
		final List<Track> tracksFromJSON = OBJECT_MAPPER.readValue(fixture("fixtures/entities/tracks.json"), new TypeReference<List<Track>>() {
		});
