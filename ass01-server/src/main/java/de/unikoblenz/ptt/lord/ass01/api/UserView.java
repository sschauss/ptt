...
public class UserView extends EntityView {
	...
	public UserView(final String label, final int id, final int trackCount, final int playlistCount, final int followersCount, final int followingsCount, final int publicFavoritesCount,
